...
public class ImportController extends BaseController {
	...
	@Autowired
	public ImportController(TownService townService, DistrictService districtService, RacerService racerService,
	...
	public ModelAndView importJson() {
		boolean[] areImported = new boolean[] { this.townService.townsAreImported(),
				this.districtService.districtsAreImported(), this.racerService.racersAreImported(),
	...
	public ModelAndView importXml() {
		boolean[] areImported = new boolean[] { this.raceEntryService.raceEntriesAreImported(),
